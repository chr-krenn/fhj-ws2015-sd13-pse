...
public class MailServiceImpl implements MailService {
	 ...
	 */
	@Override
	public void sendMail(final String subject, final String htmlBody, final String recipient) {
	...
	@Override
	@Asynchronous
	public void sendMail(final Message message, final String receipientList) {
		MimeMessage mimeMessage = new MimeMessage(session);
