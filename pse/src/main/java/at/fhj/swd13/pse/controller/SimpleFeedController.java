...
public class SimpleFeedController extends ControllerBase {
	...
	/**
	 * Adds "like" for clicked message in activity stream for the currently
	 * logged-in person
	 * 
	 */
	@SuppressWarnings("squid:S1166")
	public void rateMessage() {
		String messageId = FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap()
				.get("messageId");
	...
	/**
	 * Removes "like" for clicked message in activity stream for the currently
	 * logged-in person
	 * 
	 */
	@SuppressWarnings("squid:S1166")
