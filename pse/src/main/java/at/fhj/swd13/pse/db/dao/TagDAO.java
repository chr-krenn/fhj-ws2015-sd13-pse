...
public interface TagDAO {
	...
	/**
	 * Get a list of tokens that start with the given string. Search is case
	 * insensitive
	 * 
	 * @param beginning
	 *            the beginning of the tag-token
	 * 
	...
	/**
	 * Gets the tag with the given token Search is case insensitive
	 * 
	 * @param token
	 *            the token
	 * 
	 * @return a tag with the given token or null if none were found
	 */
	Tag getByToken(String token);
