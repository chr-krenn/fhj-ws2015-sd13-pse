...
-- -----------loadCommunitesActivities------------------------
insert into community
	(community_id, invitation_only, name, created_by, confirmed_by)
	values (200, 0, "200_SWD", 119, 108);
...
insert into message 
	(message_id, created_by, headline, message, valid_from, delivered_by) 
	values (87, 119, "Message Headline01", "Test message01", '2015-10-10 00:00:00', 1);
...
insert into message 
	(message_id, created_by, headline, message, valid_from, delivered_by) 
	values (88, 119, "Message Headline02", "Test message02", '2015-10-10 00:00:00', 1);
